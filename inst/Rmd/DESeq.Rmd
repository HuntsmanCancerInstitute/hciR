...
genes using [DESeq2].  Load the [hciR] package on Github to work with [tibbles] and simplify the [R] code.
...
# Downloaded 19639 results, grouping into 17559 rows with a unique Ensembl ID
```
